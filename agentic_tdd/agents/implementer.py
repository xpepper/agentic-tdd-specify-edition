    ...
    def _build_user_prompt(self, context: AgentContext) -> str:
        ...
        prompt_parts.extend(
            [
                ...
                "",
                "**CRITICAL**: You MUST preserve ALL existing tests and code.",
                "Do NOT remove, modify, or replace any existing tests or functions.",
                "Only ADD or UPDATE the minimal code needed to pass the failing test.",
                "",
